...
carImg = pygame.image.load("./Car racing/car_1.jpg") #load the car image
car2Img = pygame.image.load("./Car racing/car2.png")
bgImg = pygame.image.load("./Car racing/back2.jpg")
crash_img = pygame.image.load("./Car racing/crash.png")
def intro():
	intro = True
	menu1_x = 200
	menu1_y = 400
...
def gameloop():
	...
	print('Obstacle coming from RIGHT!')
	# easygui.msgbox("Obstacle coming from RIGHT!", title="simple gui")
	thing_startx = 400
	thing_starty = -600
	thingw = 50
	thingh = 100
	...
	while not gameExit:
		...
		if thing_starty > display_height:
			...
			if(i%2==0):
				...
				thing_startx = 300
				print('Obstacle coming from LEFT!')
			thing_starty = -200
